    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-xl overflow-y-auto pb-24 md:pb-4">
      <div className="relative w-full max-w-3xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden my-auto">
        ...
        <div className="p-6 md:p-12 text-center">
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 tracking-tight">Upgrade to Pro</h2>
          <p className="text-slate-400 max-w-md mx-auto mb-8 text-base md:text-lg">
            Unlock the full roadmap, live internship links, and AI-powered adaptive scheduling.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-6">
            ...
            >
              ...
              <ul className="text-left text-sm space-y-2 md:space-y-3 mb-4 md:mb-6 text-slate-400 px-2">
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> Dynamic Roadmap Updates</li>
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> 24/7 AI Career Assistant</li>
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> Internship Links</li>
              </ul>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-indigo-300">Yearly</h3>
              <div className="my-2 md:my-4 flex justify-center items-baseline gap-1">
              ...
              <ul className="text-left text-sm space-y-2 md:space-y-3 mb-4 md:mb-6 text-slate-300 px-2">
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> All Monthly Features</li>
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> Priority Internship Feed</li>
                <li className="flex items-center gap-3"><Check className="h-4 w-4 text-indigo-400 shrink-0" /> Verified Certificates</li>
              </ul>
